...
RUN apt-get update \
 && apt-get install -y --no-install-recommends ca-certificates curl git tmux unzip

# ttyd (terminal via navegador): tenta pelo apt; se nao tiver, baixa o binario
